...
### **Entities**: Representa las entidades u clases que simplifican los datos. En estas se encuentran:  
 ...
 ### **fileRead**: Este paquete contiene la clase EmployeeSchedule que a su vez contiene la función que permite la lectura del fichero. 
 ...
 ### **Tests**: Este paquete contiene la clase TestSchedules que a su vez contiene la función **main** del proyecto.  
 ...
 - Otra forma de asegurarse la lectura de los ficheros es cambiar la ruta completa, esto si no se desea seguir cualquiera de las dos indicaciones anteriores.
